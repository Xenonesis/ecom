...
INSERT INTO products (id, seller_id, name, description, category, price, discount, stock, images, rating) VALUES
  ...
  (gen_random_uuid(), NULL, 'Webcam 1080p HD', 'Full HD webcam with auto-focus and built-in microphone', 'Electronics', 69.99, 15, 60, ARRAY['https://images.unsplash.com/photo-1625948515291-69613efd103f?w=800'], 4.5),
