        ...
        <Card className="border-2 shadow-xl">
          ...
          <form onSubmit={handleSignup}>
            ...
            <CardFooter className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button variant="outline" type="button" onClick={() => handleSocialSignup('google')} disabled={loading}>
                ...
                <Button variant="outline" type="button" onClick={() => handleSocialSignup('github')} disabled={loading}>
